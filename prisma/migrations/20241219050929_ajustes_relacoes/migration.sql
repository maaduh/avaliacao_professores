...
CREATE TABLE "new_avaliacao" (
    ...
    CONSTRAINT "avaliacao_usuarioID_fkey" FOREIGN KEY ("usuarioID") REFERENCES "usuarios" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "avaliacao_professorID_fkey" FOREIGN KEY ("professorID") REFERENCES "professores" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "avaliacao_diciplinaID_fkey" FOREIGN KEY ("diciplinaID") REFERENCES "diciplina" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_comentarios" (
    ...
    "createdt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updateddt" DATETIME NOT NULL,
    CONSTRAINT "comentarios_userID_fkey" FOREIGN KEY ("userID") REFERENCES "usuarios" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "comentarios_avalID_fkey" FOREIGN KEY ("avalID") REFERENCES "avaliacao" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_professores" (
    ...
    "createdt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updateddt" DATETIME NOT NULL,
    CONSTRAINT "professores_diciplinaID_fkey" FOREIGN KEY ("diciplinaID") REFERENCES "diciplina" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
